...
package com.nolson.plugins.solanamobilewallet.data
...
class Ed25519KeyRepository(private val applicationContext: Context) {
    private val db by lazy {
        Room.databaseBuilder(applicationContext, Ed25519KeyDatabase::class.java, "keys").build()
    }
